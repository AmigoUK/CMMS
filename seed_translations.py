...
TRANSLATIONS = {
    ...
    ('ui.page.pm_planner', 'ui'): {'en': 'PM Planner', 'pl': 'Planowanie konserwacji'},
    ('ui.page.pm_tasks', 'ui'): {'en': 'PM Tasks', 'pl': 'Zadania PM'},
    ('ui.page.new_pm_task', 'ui'): {'en': 'New PM Task', 'pl': 'Nowe zadanie PM'},
    ('ui.page.edit_pm_task', 'ui'): {'en': 'Edit PM Task', 'pl': 'Edytuj zadanie PM'},
    ('ui.page.meters', 'ui'): {'en': 'Meter Readings', 'pl': 'Odczyty liczników'},
    ('ui.page.new_meter', 'ui'): {'en': 'New Meter', 'pl': 'Nowy licznik'},
    ('ui.label.task_details', 'ui'): {'en': 'Task Details', 'pl': 'Szczegóły zadania'},
    ('ui.label.schedule', 'ui'): {'en': 'Schedule', 'pl': 'Harmonogram'},
    ('ui.label.schedule_type', 'ui'): {'en': 'Schedule Type', 'pl': 'Typ harmonogramu'},
    ('ui.label.frequency', 'ui'): {'en': 'Frequency', 'pl': 'Częstotliwość'},
    ('ui.label.every', 'ui'): {'en': 'Every', 'pl': 'Co'},
    ('ui.label.next_due', 'ui'): {'en': 'Next Due', 'pl': 'Następny termin'},
    ('ui.label.last_completed', 'ui'): {'en': 'Last Completed', 'pl': 'Ostatnio wykonano'},
    ('ui.label.lead_days', 'ui'): {'en': 'Lead Days', 'pl': 'Dni wyprzedzenia'},
    ('ui.label.group_tag', 'ui'): {'en': 'Group Tag', 'pl': 'Tag grupy'},
    ('ui.label.counter_based', 'ui'): {'en': 'Counter-Based', 'pl': 'Na podstawie licznika'},
    ('ui.label.meter', 'ui'): {'en': 'Meter', 'pl': 'Licznik'},
    ('ui.label.meter_name', 'ui'): {'en': 'Meter Name', 'pl': 'Nazwa licznika'},
    ('ui.label.trigger_every', 'ui'): {'en': 'Trigger Every', 'pl': 'Wyzwalaj co'},
    ('ui.label.current_value', 'ui'): {'en': 'Current Value', 'pl': 'Aktualna wartość'},
    ('ui.label.log_reading', 'ui'): {'en': 'Log Reading', 'pl': 'Zapisz odczyt'},
    ('ui.label.recent_readings', 'ui'): {'en': 'Recent Readings', 'pl': 'Ostatnie odczyty'},
    ('ui.label.last_updated', 'ui'): {'en': 'Last Updated', 'pl': 'Ostatnia aktualizacja'},
    ('ui.label.estimated_duration', 'ui'): {'en': 'Est. Duration', 'pl': 'Szac. czas'},
    ('ui.label.checklist_template', 'ui'): {'en': 'Checklist Template', 'pl': 'Szablon listy kontrolnej'},
    ('ui.label.completion_history', 'ui'): {'en': 'Completion History', 'pl': 'Historia wykonań'},
    ('ui.label.scheduled', 'ui'): {'en': 'Scheduled', 'pl': 'Zaplanowano'},
    ('ui.label.completed', 'ui'): {'en': 'Completed', 'pl': 'Wykonano'},
    ('ui.label.completed_by', 'ui'): {'en': 'Completed By', 'pl': 'Wykonał'},
    ('ui.label.days_early', 'ui'): {'en': 'Days Early/Late', 'pl': 'Dni wcześniej/później'},
    ('ui.label.on_time', 'ui'): {'en': 'On Time', 'pl': 'Na czas'},
    ('ui.label.yes', 'ui'): {'en': 'Yes', 'pl': 'Tak'},
    ('ui.label.no', 'ui'): {'en': 'No', 'pl': 'Nie'},
    ('ui.label.eligible', 'ui'): {'en': 'Eligible', 'pl': 'Do wykonania'},
    ('ui.label.calendar', 'ui'): {'en': 'Calendar', 'pl': 'Kalendarz'},
    ('ui.label.agenda', 'ui'): {'en': 'Agenda', 'pl': 'Agenda'},
    ('ui.label.list', 'ui'): {'en': 'List', 'pl': 'Lista'},
    ('ui.label.this_week', 'ui'): {'en': 'This Week', 'pl': 'Ten tydzień'},
    ('ui.label.due_today', 'ui'): {'en': 'Due Today', 'pl': 'Na dziś'},
    ('ui.label.in_lead_window', 'ui'): {'en': 'In Lead Window', 'pl': 'W oknie wyprzedzenia'},
    ('ui.label.upcoming', 'ui'): {'en': 'Upcoming', 'pl': 'Nadchodzące'},
    ('ui.label.overdue_pms', 'ui'): {'en': 'Overdue PMs', 'pl': 'Zaległe PM'},
    ('ui.label.pm_due_this_week', 'ui'): {'en': 'PM Due This Week', 'pl': 'PM w tym tygodniu'},
    ('ui.label.pm_settings', 'ui'): {'en': 'Preventive Maintenance', 'pl': 'Konserwacja zapobiegawcza'},
    ('ui.label.pm_auto_generate_days', 'ui'): {'en': 'Auto-generate WOs (days ahead)', 'pl': 'Auto-generuj zlecenia (dni naprzód)'},
    ('ui.label.pm_default_lead_days', 'ui'): {'en': 'Default Lead Days', 'pl': 'Domyślne dni wyprzedzenia'},
    ('ui.label.pm_overdue_warning', 'ui'): {'en': 'Overdue Warning (days)', 'pl': 'Ostrzeżenie o zaległości (dni)'},
    ('ui.label.pm_overdue_critical', 'ui'): {'en': 'Overdue Critical (days)', 'pl': 'Krytyczne zaległość (dni)'},
    ('ui.label.pm_wo_prefix', 'ui'): {'en': 'WO Number Prefix', 'pl': 'Prefiks numeru zlecenia'},
    ('ui.label.pm_allow_early', 'ui'): {'en': 'Allow early completion', 'pl': 'Zezwalaj na wcześniejsze wykonanie'},
    ('ui.label.pm_auto_group', 'ui'): {'en': 'Auto-suggest task grouping', 'pl': 'Sugeruj grupowanie zadań'},
    ('ui.button.new_pm_task', 'ui'): {'en': 'New PM Task', 'pl': 'Nowe zadanie PM'},
    ('ui.button.create_pm_task', 'ui'): {'en': 'Create PM Task', 'pl': 'Utwórz zadanie PM'},
    ('ui.button.back_to_pm_tasks', 'ui'): {'en': 'Back to PM Tasks', 'pl': 'Powrót do zadań PM'},
    ('ui.button.add_checklist_item', 'ui'): {'en': 'Add Item', 'pl': 'Dodaj pozycję'},
    ('ui.button.generate_wo', 'ui'): {'en': 'Generate Work Order', 'pl': 'Generuj zlecenie'},
    ('ui.button.complete_quick', 'ui'): {'en': 'Quick Complete', 'pl': 'Szybkie wykonanie'},
    ('ui.button.view_planner', 'ui'): {'en': 'View Planner', 'pl': 'Zobacz planowanie'},
    ('ui.button.new_meter', 'ui'): {'en': 'New Meter', 'pl': 'Nowy licznik'},
    ('ui.button.create_meter', 'ui'): {'en': 'Create Meter', 'pl': 'Utwórz licznik'},
    ('ui.button.back_to_meters', 'ui'): {'en': 'Back to Meters', 'pl': 'Powrót do liczników'},
    ('ui.text.search_pm_placeholder', 'ui'): {'en': 'Search PM tasks...', 'pl': 'Szukaj zadań PM...'},
    ('ui.text.no_pm_tasks', 'ui'): {'en': 'No PM tasks found.', 'pl': 'Nie znaleziono zadań PM.'},
    ('ui.text.no_completion_history', 'ui'): {'en': 'No completions recorded yet.', 'pl': 'Brak zapisanych wykonań.'},
    ('ui.text.overdue_pm_tasks', 'ui'): {'en': 'overdue PM tasks', 'pl': 'zaległych zadań PM'},
    ('ui.text.schedule_type_help', 'ui'): {'en': 'Fixed: always from original date. Floating: from last completion.', 'pl': 'Stały: zawsze od oryginalnej daty. Ruchomy: od ostatniego wykonania.'},
    ('ui.text.lead_days_help', 'ui'): {'en': 'Days before due date when task can be done early', 'pl': 'Dni przed terminem, kiedy zadanie można wykonać wcześniej'},
    ('ui.text.group_tag_help', 'ui'): {'en': 'Group tasks at same location for combined WO', 'pl': 'Grupuj zadania w tej samej lokalizacji dla wspólnego zlecenia'},
    ('ui.text.meter_trigger_help', 'ui'): {'en': 'Trigger PM when meter advances by this amount', 'pl': 'Wyzwól PM gdy licznik wzrośnie o tę wartość'},
    ('ui.text.checklist_item_placeholder', 'ui'): {'en': 'Checklist step...', 'pl': 'Krok listy kontrolnej...'},
    ('ui.text.no_meters', 'ui'): {'en': 'No meters configured yet.', 'pl': 'Brak skonfigurowanych liczników.'},
    ('ui.text.pm_auto_generate_help', 'ui'): {'en': 'Generate WOs this many days before due date', 'pl': 'Generuj zlecenia tyle dni przed terminem'},
    ('ui.text.pm_lead_days_help', 'ui'): {'en': 'Default early execution window for new tasks', 'pl': 'Domyślne okno wcześniejszego wykonania'},
